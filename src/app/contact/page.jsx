    ...
    <>
      ...
      <section className="w-full bg-green-700 lg:pt-20 pt-10 pb-0 ">
        ...
        <p className="text-center text-white mt-2">
          Media, clinical/scientific, or partnership inquiries — we’ll respond
          quickly.
        </p>
      ...
      peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary"
                        ...
                        <button
                          type="button"
                          className="text-white flex items-center gap-2 bg-green-600 hover:bg-green-700 font-medium rounded-lg text-sm lg:px-6 px-3 lg:py-3 py-1 min-w-[200px] text-center justify-center"
                        >
                          Send
                        </button>
                      </form>
